...
const routes: Routes = [
  ...
  { path: 'admin/manage-tests', component: ManageTestsComponent, canActivate:[AuthGuardAdminService] },
  ...
  { path: 'internship/:id/test', component: TestComponent, canActivate:[AuthGuardService] },
  { path: '', redirectTo: 'home', pathMatch: 'full' },
  { path: 'internship', redirectTo: 'home', pathMatch: 'full' }
